...
public class DenyLinkingCustomIdUseCase : UseCase<bool>
{
    private readonly IPolicyAdapter _policyAdapter;

    public DenyLinkingCustomIdUseCase(IPolicyAdapter policyAdapter)
    {
    ...
    public async override Task<bool> ExecuteAsync(IProgress<double>? progress = null)
    {
        ...
        var comment = "Allow all LinkCustomIdID";
        ...
        comment = "Deny all LinkCustomIdID";
